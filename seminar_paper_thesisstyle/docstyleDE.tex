...
\newcommand{\thesistitlepage}[5]{\gentitlepage{#1}{#2}{#3\\\Large\vspace{5ex}#4}{\Large\textsc{Christian-Albrechts-Universit\"{a}t zu Kiel\\Institut f\"{u}r Informatik\\ Arbeitsgruppe Rechnergestützte Programmentwicklung }\\\vspace{10ex}\begin{tabular}{rl}Betreut durch: & Prof. Dr. R. Berghammer \\ & #5 \\\end{tabular}}}
